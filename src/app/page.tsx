      ...
      <div className="mobile-nav__wrapper">
        ...
        <div className="mobile-nav__content">
          ...
          <div className="logo-box">
            <a href="#home" aria-label="logo image"><img src="/logo-cleanox.webp" width="150" alt="" /></a>
          </div>
          ...
          <ul className="mobile-nav__contact list-unstyled">
            <li>
              ...
              <a href="mailto:info@cleanox.co.id">info@cleanox.co.id</a>
            </li>
            <li>
              <i className="fa fa-phone-alt"></i>
              <a href="tel:+6285122333381">+62 851-2233-3381</a>
            </li>
          </ul>
          <div className="mobile-nav__top">
            <div className="mobile-nav__social">
              <a href="https://wa.me/6285122333381" className="fab fa-whatsapp"></a>
